defmodule TunkTest do
	...
	test "Tunk.Router.process handles empty case" do 
		assert Tunk.Router.process(@empty_data) == :noop
	end 

	test "Tunk.Router.process handles bad data" do 
		assert Tunk.Router.process(@bad_data) == :noop
	end 
